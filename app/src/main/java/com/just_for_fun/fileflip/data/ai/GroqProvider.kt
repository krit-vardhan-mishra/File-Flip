...
class GroqProvider @Inject constructor() : AiProvider {
    ...
    override fun providerName(): String = "Groq"
    ...
    override suspend fun chat(
        ...
        if (responseCode == java.net.HttpURLConnection.HTTP_OK) {
            ...
            Log.e("GroqProvider", "API request failed: Code $responseCode, Error: $errorText")
    ...
    override fun chatStream(
        ...
        if (responseCode == java.net.HttpURLConnection.HTTP_OK) {
            ...
            while (coroutineContext.isActive && line != null) {
                if (line.startsWith("data: ")) {
                    ...
                    try {
                        ...
                        Log.w("GroqProvider", "Failed to parse SSE chunk: $line", e)
                    }
                }
            ...
            val errorText = connection.errorStream?.bufferedReader()?.use { it.readText() } ?: "HTTP $responseCode"
            Log.e("GroqProvider", "Stream request failed: Code $responseCode, Error: $errorText")
            throw Exception(parseError(errorText))
        }
